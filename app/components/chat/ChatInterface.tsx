        ...
        <div className="shadow-lg h-full flex flex-col" style={{ backgroundColor: '#0f0f10' }}>
            {!hasMessages ? (
                            ...
                            <form onSubmit={handleSubmit} className="relative">
                                <div className="relative flex items-center">
                                    <textarea
                                        ...
                                        className="w-full pl-4 pr-14 py-4 rounded-xl focus:outline-none resize-none min-h-[60px] max-h-32 transition-all duration-700 ease-in-out"
                                        style={{
                                    ...
                                    <Button
                                        ...
                                        className="absolute right-2 w-10 h-10 rounded-full flex items-center justify-center focus:outline-none disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer transition-all duration-700 ease-in-out"
                                        style={{
                ...
                <div className="h-full flex flex-col animate-in fade-in duration-700">
                    ...
                    <div className="px-4 pt-1 pb-4 animate-in slide-in-from-top duration-700">
                        <form onSubmit={handleSubmit} className="relative">
                            <div className="relative flex items-center">
                                <textarea
                                    ref={textareaRef}
